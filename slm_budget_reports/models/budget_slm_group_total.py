...
class BudgetSLMGroupTotalReport(models.AbstractModel):
    _name = "budget.slm.group.total.report"
    ...
    def _get_report_name(self):
        ...
        try:
            name = 'Budget ' + results[0]
        except IndexError:
            name = ''
        return _(name)

    def _get_templates(self):
        templates = super(BudgetSLMGroupTotalReport, self)._get_templates()

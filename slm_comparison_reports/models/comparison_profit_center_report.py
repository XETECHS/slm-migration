...
class ComparisonProfitCenterReport(models.AbstractModel):
    _name = "comparison.profit.center.report"
    _description = "Comparison Profit Center Report"
    ...
    def _get_report_name(self):
        return _("Comparison Profit Center Report")

    def _get_templates(self):
        templates = super(ComparisonProfitCenterReport, self)._get_templates()
    ...
    def _set_context(self, options):
        ctx = super(ComparisonProfitCenterReport, self)._set_context(options)
        profit_centers = []
    ...
    def _get_options(self, previous_options=None):
        if not previous_options:
            previous_options = {}
        options = super(ComparisonProfitCenterReport, self)._get_options(previous_options)
        if options.get('profit_center'):

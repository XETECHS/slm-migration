...
class ComparisonEncryptionReport(models.AbstractModel):
    _name = "comparison.encryption.report"
    ...
    def _get_report_name(self):
        return _("Comparison Encryption Report")

    def _get_templates(self):
        templates = super(ComparisonEncryptionReport, self)._get_templates()
    ...
    def _do_query(self, options, line_id):
        ...
        sql_end = """
            ...
            GROUP BY account, account_name, analytic_account, analytic_account_name, profit_center, profit_center_name,
                     profit_center_code, tag
